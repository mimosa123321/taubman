        ...
        return <div className = "detail">
            ...
            <div className = "detailContents">
                <div className="content opening">
                    <h1>China set to become the world's number 1 retail market by 2018</h1>
                    <img src="src/images/content_opening.png" />
                ...
                <div className="content malls">
                    ...
                    <div className="box">
                        ...
                        <img src="src/images/content_malls.png" />
                    </div>
                </div>
                ...
                <div class="content ecommerce">
                    ...
                    <div class="box">
                        ...
                        <img src="src/images/content_ecommerce.png" />
                    </div>
                </div>

                <div class="content retail">
                    ...
                    <div class="box">
                        ...
                        <img src="src/images/content_retail.png" />
                    </div>
                </div>


                <div class="content demographics">
                    <h1>Demographics and Economy</h1>
                    <div class="box">
                    ...
                    <div class="box">
                        ...
                        <img src="src/images/content_demographics.png" />
                    </div>
                </div>
            </div>
